...
<div class="row">
		  ...
		  <ol class="breadcrumb">
			...
			<li><a href="#" data-toggle="modal" data-target="#myModalalt" data-id-alternatif="tabel-analisa">Tabel Analisa Alternatif</a></li>
		</ol>
			...
			<div class="panel-body">
				<form method="post" action="analisa-alternatif-tabel.php">
					...
					<?php $no=1; foreach ($r as $k => $v): ?>
						...
						<?php endfor; ?>
					<?php endforeach; ?>
					<button type="submit" name="submit" class="btn btn-primary"> Selanjutnya <span class="fa fa-arrow-right"></span></button>
				</form>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabelalt">Perbandingan Menurut Alternatif</h4>
			</div>
