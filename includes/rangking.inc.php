...
class Rangking {
	...
	function readKhusus(){
		...
		$query = "SELECT * FROM data_alternatif a, data_kriteria b, data_raking c where a.id_alternatif=c.id_alternatif and b.id_kriteria=c.id_kriteria order by a.id_alternatif asc";
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
